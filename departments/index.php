...
<head>
    ...
    <title>UDM Study Plan Generator - Manage Departments</title>
    ...
    <div class="container">
        ...
        <div class="main">
            <div class="main-header">
                <div>
                    <h1 class="main-title">Department List</h1>
                    <p class="sub-title">Manage academic departments</p>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="actions">
                                    ...
                                    <a href="delete.php?id=<?= $row['id'] ?>" onclick="return confirm('Are you sure you want to delete this department?')" class="btn btn-sm btn-delete">
