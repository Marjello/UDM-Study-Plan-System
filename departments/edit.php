...
$id = $_GET['id'];
$query = $conn->query("SELECT * FROM departments WHERE id = $id");
$dept = $query->fetch_assoc();
...
<head>
    ...
    <title>UDM Study Plan Generator - Edit Department</title>
    ...
    <div class="container">
        ...
        <div class="main">
            <div class="main-header">
                <div>
                    <h1 class="main-title">Edit Department</h1>
                    <p class="sub-title">Update department details</p>
                </div>
