...
<head>
    ...
    <title>UDM Study Plan Generator - Add New Department</title>
    ...
    <div class="container">
        ...
        <div class="main">
            <div class="main-header">
                <div>
                    <h1 class="main-title">Add New Department</h1>
                    <p class="sub-title">Create a new academic department</p>
                </div>
            ...
            <div class="content-card">
                <form method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" required placeholder="e.g., College of Engineering">
                    </div>
