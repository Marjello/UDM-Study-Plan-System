...
--
-- Host: 127.0.0.1
-- Generation Time: May 11, 2025 at 07:17 PM
...
--
-- Table structure for table `student_subject_adjustments`
--

CREATE TABLE `student_subject_adjustments` (
  `id` int(11) NOT NULL,
  `student_id` int(11) NOT NULL,
  `subject_id` int(11) NOT NULL,
  `original_year_level` int(11) NOT NULL,
  `original_semester` int(11) NOT NULL,
  `adjusted_year_level` int(11) NOT NULL,
  `adjusted_semester` int(11) NOT NULL,
...
--
-- Indexes for table `student_subject_adjustments`
--
ALTER TABLE `student_subject_adjustments`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `student_subject_unique` (`student_id`,`subject_id`);
...
--
-- AUTO_INCREMENT for table `student_subject_adjustments`
--
ALTER TABLE `student_subject_adjustments`
