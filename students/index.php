...
$students = $conn->query("SELECT s.*, c.course_name FROM students s JOIN courses c ON s.course_id = c.id");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>UDM Study Plan Generator - Students</title>
        ...
        <div class="main">
            <div class="main-header">
                <div>
                    ...
                    <p class="sub-title">Manage student records and information</p>
                </div>
                ...
                <div class="table-container">
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                                <td><span class="badge badge-primary"><?= htmlspecialchars($row['student_id']) ?></span></td>
                                ...
                                <td class="actions">
                                    ...
                                    <a href="delete.php?id=<?= $row['id'] ?>" onclick="return confirm('Are you sure you want to delete this student?')" class="btn btn-sm btn-delete">
