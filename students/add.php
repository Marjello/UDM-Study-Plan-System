...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO students (student_id, full_name, course_id) VALUES (?, ?, ?)");
    $stmt->bind_param("ssi", $student_id, $full_name, $course_id);
    $stmt->execute();
...
<head>
    ...
    <title>UDM Study Plan Generator - Add New Student</title>
    ...
    <div class="container">
        ...
        <div class="main">
            <div class="main-header">
                <div>
                    <h1 class="main-title">Add New Student</h1>
                    <p class="sub-title">Register a new student in the system</p>
                </div>
            ...
            <div class="content-card">
                <form method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" name="student_id" class="form-control" required placeholder="e.g., 2023-12345">
                    </div>
