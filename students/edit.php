...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE students SET student_id = ?, full_name = ?, course_id = ? WHERE id = ?");
    $stmt->bind_param("ssii", $student_id, $full_name, $course_id, $id);
    $stmt->execute();
...
<head>
    ...
    <title>UDM Study Plan Generator - Edit Student</title>
        ...
        <div class="main">
            <div class="main-header">
                <div>
                    ...
                    <p class="sub-title">Update student information</p>
                </div>
