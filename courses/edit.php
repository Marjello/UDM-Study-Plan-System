...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE courses SET course_name=?, course_code=?, department_id=? WHERE id=?");
    $stmt->bind_param("ssii", $course_name, $course_code, $department_id, $id);
    $stmt->execute();
...
<head>
    ...
    <title>UDM Study Plan Generator - Edit Program</title>
    ...
    <div class="container">
        ...
        <div class="main">
            <div class="main-header">
                <div>
                    <h1 class="main-title">Edit Program</h1>
                    <p class="sub-title">Update program information</p>
                </div>
            ...
            <div class="content-card">
                <form method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" name="course_code" class="form-control" value="<?= htmlspecialchars($course['course_code']) ?>" required placeholder="e.g., CS101">
                    </div>
                    
                    <div class="form-group">
                        <label class="form-label">Program Name:</label>
                        <input type="text" name="course_name" class="form-control" value="<?= htmlspecialchars($course['course_name']) ?>" required placeholder="e.g., Introduction to Computer Science">
                    </div>
