...
<head>
    ...
    <title>UDM Study Plan Generator - Add New Program</title>
    ...
    <div class="container">
        ...
        <div class="main">
            <div class="main-header">
                <div>
                    <h1 class="main-title">Add New Program</h1>
                    <p class="sub-title">Create a new academic program</p>
                </div>
            ...
            <div class="content-card">
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="course_name" class="form-control" required placeholder="e.g., Introduction to Computer Science">
                    </div>
